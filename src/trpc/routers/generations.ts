...
export const generationsRouter = createTRPCRouter({
    getById: orgProcedure
        ...
        .query(async ({input, ctx}) => {
            const generation = await prisma.generatedVoice.findUnique({
        ...
        getAll: orgProcedure.query(async ({ ctx }) => {
            const generations = await prisma.generatedVoice.findMany({
        ...
        create: orgProcedure
            ...
            .mutation(async ({input, ctx}) =>{
                ...
                try {
                    const generation = await prisma.generatedVoice.create({
                        data: {
                            orgId: ctx.orgId,
                            text: input.text,
